       ...
       <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
           ...
           <div class="ms-auto">
               <div class="btn-group">
                   ...
                   <a href="{{ route('index.blog') }}" class="btn btn-primary"><i class="fadeIn animated bx bx-plus"></i> Blog List</a>
               </div>
           </div>
       </div>
       <!--end breadcrumb-->
                        ...
                        <div class="card-body">
                            <div class="digital-add needs-validation">
                                <div class="form-group">
                                    ...
                                    <input class="form-control  @error('title') is-invalid @enderror" id="name" type="text" required="" name="title" value="{{ $blog->title }}"> 
                                    @error('title')
                              ...
                              {{--   <div class="form-group">
                                    ...
                                    <input class="form-control  @error('slug') is-invalid @enderror" id="slug" type="text" required="" name="slug" value="{{ $blog->slug }}"> 
                                    @error('slug')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('blogcate_id') is-invalid @enderror"  name="blogcate_id"  required="" value="{{ old('blogcate_id') }}" >
                                        ...
                                        <option value="{{ $blogcate->id }}" @if($blog->blogcate_id == $blogcate->id) selected @endif>{{ $blogcate->name }}</option>
                                        @endforeach
                              ...
                              <!--  -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                        <img src="{{ asset('storage/app/public/'.$blog->image) }}"  class="img-thumbnail mt-2" width="100%" id="photo">
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="digital-add needs-validation">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="validationCustom05" type="text" value="{{ $blog->meta_tag }}" name="meta_tag">
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label">Meta Description</label>
                                    <textarea rows="4" cols="12" class="form-control" name="meta_description">{{ $blog->meta_description }}</textarea>
